...
# Create relationships with Keycloak user format matching Keycloak groups
echo "[*] Creating Keycloak user relationships..."
zed relationship create "group:admin" "editor" "keycloak:user:edvin" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
zed relationship create "group:editors" "editor" "keycloak:user:alice" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
zed relationship create "group:viewers" "viewer" "keycloak:user:bob" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
...
zed relationship create "document:doc1" "editor_user" "keycloak:user:edvin" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
zed relationship create "document:doc1" "deleter_user" "keycloak:user:edvin" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
zed relationship create "document:doc2" "editor_user" "keycloak:user:edvin" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
zed relationship create "document:doc2" "deleter_user" "keycloak:user:edvin" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"

# Alice (editors group member) should have edit permissions on doc1, view permissions on doc2
zed relationship create "document:doc1" "editor_user" "keycloak:user:alice" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
zed relationship create "document:doc2" "viewer_user" "keycloak:user:alice" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"

# Bob (viewers group member) should only have view permissions
zed relationship create "document:doc1" "viewer_user" "keycloak:user:bob" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
zed relationship create "document:doc3" "viewer_user" "keycloak:user:bob" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
...
zed relationship create "keycloak:user:edvin" "delegate" "service:spiffe-example-org-ns-app-sa-service-a" \
...
zed relationship create "keycloak:user:alice" "delegate" "service:spiffe-example-org-ns-app-sa-service-a" \
...
zed relationship create "keycloak:user:bob" "delegate" "service:spiffe-example-org-ns-app-sa-service-a" \
...
zed relationship create "proxy_access:doc1_as_edvin" "user" "keycloak:user:edvin" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
...
zed relationship create "proxy_access:doc1_as_alice" "user" "keycloak:user:alice" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
...
zed relationship create "proxy_access:doc3_as_bob" "user" "keycloak:user:bob" --endpoint localhost:50051 --insecure --token "averysecretpresharedkey"
